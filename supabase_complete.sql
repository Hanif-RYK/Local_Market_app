...
INSERT INTO service_categories (name, icon, is_free_forever, sort_order) VALUES
  ('Mazdoor / Labour','👷',1,1), ('Mistri / Construction','🔨',0,2), ('Plumber','💧',0,3),
  ('Electrician','⚡',0,4), ('Carpenter','🪟',0,5), ('Painter','🎨',0,6),
  ('AC Mechanic','❄️',0,7), ('General Mechanic','🔧',0,8), ('Welder','🔩',0,9),
  ('Tile / Floor Work','🏗️',0,10), ('Roof Work','🏠',0,11), ('Other Service','🛠️',0,12)
